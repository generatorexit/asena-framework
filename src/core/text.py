...
# text menu for asena menu stuff
from src.core.asenacore import bcolors, get_version, check_os

# grab version of asena
...
main_menu = ['anonsurf',
             ...
             'third party modules',
             'update the asena',
             'update asena configuration',
             'help, credits, and about\n']

main_menu = ['Asena',
             'Third Party Modules',
             'Update the Asena Framework',
             'Update Asena Framework Configuration',
             'Help, Credits, and About\n']
