...
update_config.py:
    ...
    This module converts the user-editable asena.config text file
    into a python module file. This allows the user to edit
    the configuration with easily understandable values such
    as "ON" or "OFF", but yet Asena operates with a module from
...
from src.core.asenacore import print_status, print_info, print_error, return_continue
...
def update_config():
    ...
    init_file = open("/etc/asena-framework/asena.config", "r")
    new_config = open("/etc/asena-framework/asena_config.py", "w")
...
#########################################################################
#  This file is generated by a routine inside Asena, for use by Asena.  #
#                                                                       #
#  Settings should be modified in the asena.config file, and then       #
#  Asena updated using the 'Update Asena Configuration' menu item in    #
#  the main menu. This file will be updated with the new settings.      #
#                                                                       #
#  asena.config.py generated: """ + timestamp + """                     #
#                                                                       #
#########################################################################
CONFIG_DATE='""" + timestamp + """'\n""")
    ...
    new_config.close()
    sleep(1)
    sys.path.append("/etc/asena-framework")
    from asena_config import CONFIG_DATE as verify
    print_info("New asena.config.py file generated on: %s" % timestamp)
    ...
    print_status("Asena is using the new config, no need to restart")
    return_continue()
