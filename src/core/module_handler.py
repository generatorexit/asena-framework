...
# get the menu going
print("\n")
print_info_spaces("Asena Framework third party modules menu.")
print_info_spaces("Read the readme/modules.txt for information on how to create your own modules.\n")
    ...
    for name in glob.glob("modules/*.py"):
        ...
        if counter == int(choice):
            ...
            # handle the exception if main isn't there
                ...
                input("   [!] There was an issue with a module: %s." % (e))
                return_continue()
