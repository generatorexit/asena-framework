# The Asena Framework (TAF)
* Copyright :copyright: 2022
* Written by: Mert Karagöz (@generatorexit)

<br/>

## Description
The Asena Framework is an open-source penetration testing framework designed for social engineering. Asena has a number of custom attack vectors that allow you to make a believable attack quickly. SET is a product of TrustedSec, LLC – an information security consulting firm located in Cleveland, Ohio.
